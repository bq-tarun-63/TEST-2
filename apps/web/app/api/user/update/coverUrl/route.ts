...
export async function PATCH(req: NextRequest) {
    try {
        ...
        // Validate coverUrl
        if (coverUrl !== undefined && typeof coverUrl !== 'string' && coverUrl !== null) {
            return NextResponse.json({ message: "Invalid coverUrl format" }, { status: 400 });
        }
        ...
        console.error("Error updating user coverUrl:", error);
